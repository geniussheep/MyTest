//------------------------------------------------------------------------------
// <copyright file="RightMenu.cs" company="Company">
...
namespace MenuCommand
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class RightMenu
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("879aee8a-80f9-422f-b26e-44caf36ba7fe");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RightMenu"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        private RightMenu(Package package)
        {
            if (package == null)
            {
...
//                menuItem.BeforeQueryStatus += menuCommand_BeforeQueryStatus;
        ...
        {
            Instance = new RightMenu(package);
        }
        ...
        private void MenuItemCallback(object sender, EventArgs e)
        {
            ...
            var selectProject = selectedItems.Item(projectName.First()).Project; ;
            System.Windows.Forms.MessageBox.Show("Solution startup Project: " + projectName.First());
