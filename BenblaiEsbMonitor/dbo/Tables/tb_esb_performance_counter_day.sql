CREATE TABLE [dbo].[tb_esb_performance_counter_day] (
    ...
    CONSTRAINT [topic_ServerId_ConsumerClientAppId_ProducerClientAppId_FromDate] UNIQUE NONCLUSTERED ([topic] ASC, [server_id] ASC, [consumer_client_app_id] ASC, [producer_client_app_id] ASC, [from_date] ASC)
);
