...
namespace NugetPublishExtTool.Extensions
{
    public static class ProjectExtension
    {
        ...
        /// <returns></returns>
        public static SelectedProjectInfo GetSelectedProjectInfo(this DTE dte)
        {
            ...
            if (!selectedItems.MultiSelect && selectedItems.Count == 1)
            {
                ...
                return new SelectedProjectInfo(selectProject.Project.FullName, selectProject.Project, projectFileList, dte.Solution);
            }
